...
After setting the initial application, the next step is to install `shiny.i18n` and add it to the dependencies.

_NOTE: `shiny.i18n` compatibility with `rhino` is currently available only in the development version. The installation guide will be updated after the CRAN release._
...
A Rhino application is usually built from multiple Shiny modules.
