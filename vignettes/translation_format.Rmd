...
Note that in CSV consists of two columns. The left is a **key translation** with its code in header.
The right is a target translation with its code as a column name. The code needs to match the csv file name.

Having said that you can create CSV files. For [Klingon](https://en.wikipedia.org/wiki/Klingon_language) it would look like this:
...
`translation_it.csv` for Italian.
